...
<template>
  <article class="project-item group flex items-start gap-3.5 border-b border-border px-[3px] pt-[29px] pb-[31px] transition-[padding-left] duration-200 hover:pl-[7px]">
    <Box class="project-icon mt-[3px] shrink-0 text-text-faint transition-colors duration-200 group-hover:text-text" :size="17" :stroke-width="1.7" aria-hidden="true" />
    <div class="project-content min-w-0">
      <div class="project-title-row">
        <h3 class="m-0 font-mono text-sm leading-[1.4] font-[620] tracking-[-0.02em] text-text">
          <a v-if="project.url" class="inline-flex items-center gap-[5px] no-underline hover:underline hover:underline-offset-4" :href="project.url" target="_blank" rel="noopener noreferrer">
            {{ project.name }}
